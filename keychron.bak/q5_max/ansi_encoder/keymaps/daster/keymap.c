...
// A acts as GUI (Cmd/Win) when held
//#define HOME_A LGUI_T(KC_A)
// S acts as Alt when held
/* #define HOME_S LALT_T(KC_S)   */
// D acts as Option when held
#define HOME_D LOPT_T(KC_D)
// F acts as CMD when held
#define HOME_F LCMD_T(KC_F)

// J acts as Ctrl when held
/* #define HOME_J RCTL_T(KC_J)   */
/* // K acts as Shift when held */
/* #define HOME_K RSFT_T(KC_K)   */
/* // L acts as Alt when held */
/* #define HOME_L RALT_T(KC_L)   */
/* // ; acts as GUI (Cmd/Win) when held */
/* #define HOME_SCLN RGUI_T(KC_SCLN)  */

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_101(
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,  KC_VOLU,            KC_DEL,   KC_F13,   KC_CAPS,  KC_F15,     KC_MUTE,
        ...
        KC_LCTL,  KC_A,     KC_S,     HOME_D,   HOME_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_HYPR,  KC_P4,    KC_P5,    KC_P6,      KC_PPLS,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,              KC_P1,    KC_P2,    KC_P3,
        KC_LCTL,  KC_LOPT, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD, MO(MAC_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,            KC_P0,    KC_PDOT,    KC_PENT),
